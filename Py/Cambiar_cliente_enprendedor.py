...
class Cambiar:
    def __init__(self, root, id, nombre, apellido, direccion, regimen):
        self.root = root
        ...
        tituloLabel = tk.Label(marco, text="Informacion personal", bg=colorMarco, fg=colorLabel, font=letraLabel)
...
if __name__ == "__main__":
    ...
    app = Cambiar(root, id, nombre, apellido, direccion, regimen)
    root.mainloop()
