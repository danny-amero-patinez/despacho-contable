...
class AddClientApp:
    def __init__(self, root):
        ...
        regimen_fiscal_label = tk.Label(frame, text="Regimen Fiscal:", bg=color_frame, fg=color_label,
                                        font=("Arial", 14))
        regimen_fiscal_label.grid(row=12, column=0, sticky="w", padx=10, pady=5)
        ...
        self.regimen_fiscal_combobox.grid(row=12, column=1, padx=10, pady=5)
        ...
        register_button.grid(row=13, column=0, columnspan=2, pady=10)
