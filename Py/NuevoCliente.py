...
class AddClientApp:
    def __init__(self, root):
        ...
        name_label9.grid(row=9, column=0, sticky="w", padx=10, pady=5)
        ...
        self.regimen_combobox.grid(row=15, column=1, padx=10, pady=5)
        ...
        register_button.grid(row=16, column=0, columnspan=2, pady=10)
    ...
    def insert_variables_into_table(
            self, v1, v2, v3, v4, v5, v6, v7, v8, v9
    ):
        try:
            ...
            record = (v1, v2, v3, v4, v5, v6, v7, "", v8, "", "", v9, "", "", "", "")
    ...
    def register_client(self):
        self.insert_variables_into_table(
            ...
            self.name_entry6.get(), self.name_entry9.get(), self.name_entry10.get(),
            self.name_entry11.get(), self.direccion_entry.get(), self.regimen_combobox.get()
        )
