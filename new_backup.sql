...
INSERT INTO `agentes` VALUES (1,'2023-10-25 00:55:21','Ivan Hernandez','password1234','Prepa trunca','Esteban','Con la muñeca fracturada','Espero que ninguna','Se ve','Panadero',30,'?','?','?','?','Enrique Segobiano','?',1,'Ivan','?'),(2,'2023-11-14 17:56:39','d','d','','','','','','',0,'0','','d','d','','d',0,'d','');
...
--
-- Table structure for table `atencionemprendedores`
--

DROP TABLE IF EXISTS `atencionemprendedores`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `atencionemprendedores` (
...
--
-- Dumping data for table `atencionemprendedores`
--

LOCK TABLES `atencionemprendedores` WRITE;
/*!40000 ALTER TABLE `atencionemprendedores` DISABLE KEYS */;
/*!40000 ALTER TABLE `atencionemprendedores` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `clientes` VALUES (1,'2023-11-01 00:58:52','some','some','some','some','some','some','some','some','some','','Régimen de Actividades Empresariales y Profesionales','some','some','some','',''),(2,'2023-11-01 01:02:15','some2','some2','some2','some2','some2','some2','some2','some2','some2','','Régimen de Sueldos y Salarios','some2','some2','some2','',''),(3,'2023-11-14 17:09:49','Danny','','','','','','','','','Unknown','Danny','','1234','','',''),(4,'2023-11-14 18:07:14','d','d','d','d','d','d','d','','d','','','Régimen de Actividades Agrícolas, Ganaderas, Silvícolas y Pesqueras','','','','');
...
INSERT INTO `emprendedores` VALUES (1,'2023-11-07 05:41:25',NULL,NULL,NULL,NULL,NULL,NULL,'test',NULL,NULL,'test','test','test',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'2023-11-03 08:54:51',NULL,NULL,NULL,NULL,NULL,NULL,'test',NULL,NULL,'test','test','test',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'2023-11-14 18:27:48',NULL,NULL,NULL,NULL,0,NULL,'d',0,0,'d','d','d',0,NULL,0,0,0,NULL,'d','d',NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2023-11-19 20:54:02
